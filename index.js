...
var vertexColors = [
    ...
    [
        vec4(1, 0.1, 0.0, 1.0),  // black
        vec4(1, 0.2, 0.0, 1.0),  // red
        vec4(1, 0.3, 0.5, 1.0),  // yellow
        vec4(1, 0.4, 0.1, 1.0),  // green
        vec4(1, 0.5, 0.0, 1.0),  // blue
        vec4(1, 0.6, 0.2, 1.0),  // magenta
        vec4(1, 0.7, 0.5, 1.0),  // white
        vec4(1, 0.8, 0.5, 1.0)   // cyan
    ],
    [
        vec4(0.0, 0.0, 0.0, 1.0),  // black
        vec4(1.0, 0.0, 0.0, 1.0),  // red
