...
var InitDemo = function (){
    ...
    if(!gl.getProgramParameter(program, gl.VALIDATE_STATUS)){
        console.error('Erro de validação', gl.getProgramInfoLog(program));
        return;
    }

    var vertice_triangulo =
    [   //X  Y,     R, G, B
        -0.5, 0.5,   1.0, 1.0, 0.0,
        -0.5, -0.5, 0.7, 0.0, 1.0,
        0.5, -0.5,   0.1, 1.0, 0.6
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertice_triangulo), gl.STATIC_DRAW);
